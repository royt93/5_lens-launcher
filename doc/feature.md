...
1. **Themed icon + debug StrictMode** — small Android 13 icon enhancement and development-only diagnostics.
2. **FISH-007 — Depth-of-field blur by focus distance** — render hot path, needs frame-timing evidence.
3. **FISH-009 — Live pinch-to-adjust lens curvature** — last, with gesture-conflict coverage.
